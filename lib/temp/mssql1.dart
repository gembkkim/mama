          ...
          SingleChildScrollView(
            child: Padding(
              ...
              child: Column(children: [
                Row(children: [
                  Flexible(
                      child: customTextField("127.0.0.1", //IP address
                          onchanged: (p0) => ip = p0,
                          keyboardType: TextInputType.number)                 ),
                  const SizedBox(width: 10),
                  Flexible(
                      child: customTextField("1433",
                          onchanged: (p0) => port = p0,
                          keyboardType: TextInputType.number))
                ]),
                customTextField("testdb",
                    onchanged: (p0) => databaseName = p0),
                customTextField("tester", onchanged: (p0) => username = p0),
                customTextField("qwer1324", onchanged: (p0) => password = p0),
                      ...
                      child: Column(
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              const Text("read query", style: textStyle),
                              IconButton(
                      ...
                      child: Column(
                        ...
                        children: [
                          Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              const Text("write query", style: textStyle),
                              IconButton(
